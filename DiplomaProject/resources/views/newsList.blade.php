  ...
  <div class="modal-dialog" role="document" >
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">{{__('local.Insert a movie')}}</h5>
      ...
      <div class="modal-body">
            <div class="form-group">
                ...
                <input type="text" name='title_en' class="form-control" placeholder="{{__('local.Enter title on English')}}" value="{{ old('title_en') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name='description_en' class="form-control" placeholder="{{__('local.Enter description on English')}}" value="{{ old('description_en') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name='title_ru' class="form-control" placeholder="{{__('local.Enter title on Russian')}}" value="{{ old('title_ru') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name='description_ru' class="form-control" placeholder="{{__('local.Enter description on Russian')}}" value="{{ old('description_ru') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name='photo1' class="form-control" placeholder="{{__('local.Enter link to the photo')}}" value="{{ old('photo1') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name='photo2' class="form-control" placeholder="{{__('local.Enter link to the photo')}}" value="{{ old('photo2') }}">
            </div>
            <div class="form-group">
                <label>{{__('local.Photo 3:')}}</label>
                <input type="text" name='photo3' class="form-control" placeholder="{{__('local.Enter link to the photo')}}" value="{{ old('photo3') }}">
            </div>
      </div>
